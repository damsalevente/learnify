...
router.get('/depots', control_depot.depot_list, util.send_json);
router.get('/depots/:depotid', control_depot.depot_detail, util.send_json);
router.post('/depots', control_depot.depot_update_get, util.send_json);
router.put('/depots/:depotid',control_depot.depot_detail,  control_depot.depot_update_get, util.send_json);
router.put('/depots/:depotid/products',control_depot.depot_detail,  control_depot.depot_update_amount, util.send_json);
router.delete('/depots/:depotid',control_depot.depot_detail, control_depot.depot_delete_get, util.send_json);
/* in that way, we will only use the product's id, and we push it to the ref array*/
router.post('/depots/:depotid/products',control_depot.depot_detail,  control_depot.depot_add_product, util.send_json);
router.delete('/depots/:depotid/products/:product_id',control_depot.depot_detail, control_depot.depot_delete_product, util.send_json);
...
router.delete('/partners/:partnerid',control_partner.partner_detail,  control_partner.partner_delete_get, util.send_json);
...
router.delete('/orders/:orderid',control_order.order_detail, control_order.order_delete_get, util.send_json);
